...
{
    public sealed partial class ProjetoAideView : UserControl
    {
        public ProjetoAideView()
        {
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(ProjetoAideView), new PropertyMetadata(0));


        public ProjetoAideState State
        {
            get { return (ProjetoAideState)GetValue(StateProperty); }
            set
            {
                switch (value)
                {
                    case ProjetoAideState.Listening:
                        TextTextBlock.Foreground = App.Current.Resources["MainBackground"] as SolidColorBrush;
                        break;
                    case ProjetoAideState.Thinking:
                        TextTextBlock.Foreground = App.Current.Resources["BrandColor"] as SolidColorBrush;
                        Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, async () =>
                        {
                            while (State == ProjetoAideState.Thinking)
                            {
                        ...
                        break;
                    case ProjetoAideState.Speaking:
                        TextTextBlock.Foreground = App.Current.Resources["BrandColor"] as SolidColorBrush;
                        Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, async () =>
                        {
                            while (State == ProjetoAideState.Speaking)
                            {
                                await Logo.Scale(1.3f, 1.3f, 20, 20, 200).StartAsync();
        ...
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register("State", typeof(ProjetoAideState), typeof(ProjetoAideView), new PropertyMetadata(0));
